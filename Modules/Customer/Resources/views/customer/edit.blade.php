...
<section id="multiple-column-form">
    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    class="form-control @error('mobile') is-invalid @enderror" value="{{$customer->mobile}}" name="mobile" required>
                                @error('mobile')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="tel" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" maxlength="10"
                                    class="form-control @error('alter_no') is-invalid @enderror" name="alter_no" value="{{$customer->alter_no}}" required>
                                @error('alter_no')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control " id="country" name="country" data-index="3"  onchange="getBillingState()">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control " id="state" name="state" data-index="3"  onkeydown="setNextField(event)"  onchange="getDeliveryCity()">>
                                        @foreach($state as $State)
                                        <option  value='{{$State->id}}' @if($State->id == $customer->state->id) selected @endif >{{$State->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('state')
                                       <h5 class="alert alert-danger">{{$message}}</h5>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control " id="city" name="city" data-index="3"   onkeydown="setNextField(event)">
                                    @foreach($city as $City)
                                    <option  value='{{$City->id}}' @if($City->id == $customer->city->id) selected @endif >{{$City->name}}</option>
                                    @endforeach
                                    </select>
                                    @error('city')
                                       <h5 class="alert alert-danger">{{$message}}</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="fp-default" class="form-control flatpickr-basic"
                                            name="dob" placeholder="YYYY-MM-DD" value="{{$customer->dob}}" />
                                        @error('dob')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="fp-default" class="form-control flatpickr-basic"
                                            name="aniversary_date" placeholder="YYYY-MM-DD" value="{{$customer->aniversary_date}}"/>
            ...
            <div class="col-md-1">
                <button class="btn btn-sm global_btn_color" style="background-color: #009973; color:white; border-radius: 10px" type="submit">Update</button>
...
function getBillingState()
        {
            ...
            var deliverycountryid = document.getElementById('country').value;
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    {
                        $('#state').html("<option>Record Not Found</option>");
        ...
        function getDeliveryCity()
        {
            ...
            var deliverystateid = document.getElementById('state').value;
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    {
                        $('#city').html("<option>Record Not Found</option>");
