            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Agent Master</h4>
                        <a class="btn global_btn_color" href="{{route('master.agent.create')}}" type="submit"><svg
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm global_btn_color"
                                        href="{{route('master.agent.edit',['id'=>$agent->id])}}" type="submit"><svg
