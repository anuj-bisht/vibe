...
<div class="container">
        ...
        <section id="basic-input">
            ...
            <div class="row">
                <div class="col-md-12">
                <form class="needs-validation" novalidate method="POST" action="{{route('master.collection.update',['id'=>$collection->id])}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">

                            <label for="validationTooltip01">Collection Code</label>
                            <input type="text" class="form-control" name="code" placeholder="Collection Code" value="{{$collection->code}}"  required autofocus/>
                        </div>

                        <div class="col-md-12 col-12 mb-3">

                            <label for="validationTooltip01">Collection Name</label>
                            <input type="text" class="form-control" name="name" placeholder="Collection Name" value="{{$collection->name}}" required />
                        </div>
