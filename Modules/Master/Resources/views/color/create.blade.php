                ...
                <form class="needs-validation" novalidate method="POST" action="{{route('master.color.store')}}">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="color_code" placeholder="Color Code"  required autofocus oninput="this.value = this.value.toUpperCase()" />
                            @error('color_code')
                        ...
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Color Name"  required oninput="this.value = this.value.toUpperCase()"/>
                            @error('name')
                                            <h5 class="alert alert-danger">{{$message}}</h5>
                                        @enderror
                        </div>
