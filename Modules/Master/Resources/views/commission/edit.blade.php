...
<div class="container">
        <section id="basic-input">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="needs-validation" novalidate method="POST" action="{{route('master.commission.update',['id'=>$commission->id])}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">

                            <label for="validationTooltip01">Code</label>
                            <input type="text" class="form-control" name="code" placeholder="Code" value="{{$commission->code}}"  required autofocus oninput="this.value = this.value.toUpperCase()"/>
                            @error('code')
                        ...
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="percent" placeholder="Discount (%)" value="{{$commission->percent}}"  required oninput="this.value = this.value.toUpperCase()"/>
                            @error('discount')
                                            <h5 class="alert alert-danger">{{$message}}</h5>
                                        @enderror
                        </div>
