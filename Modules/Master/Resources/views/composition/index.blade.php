            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Composition Master</h4>
                        <a class="btn global_btn_color" href="{{route('master.composition.create')}}" type="submit"><svg
                    ...
                    <table class="table" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$composition->text}}</td>
                                <td><a class="btn btn-sm global_btn_color"
                                        href="{{route('master.composition.edit',['id'=>$composition->id])}}" type="submit"><svg
