...
<div class="container">
    <section id="basic-input">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="needs-validation" novalidate method="POST" action="{{route('master.crm.store')}}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-3 col-3 mb-3">
                            <label for="validationTooltip01">CRM Name</label>
                            <input type="text" class="form-control" name="crm_name" placeholder="CRM Name" required autofocus oninput="this.value = this.value.toUpperCase()"/>
                            @error('crm_name')
                        ...
                        <div class="col-md-3 col-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="designation" placeholder="Designation" required autofocus oninput="this.value = this.value.toUpperCase()"/>
                            @error('designation')
                            <h5 class="alert alert-danger">{{$message}}</h5>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 col-3 mb-3">
                            ...
                            <input type="number" class="form-control" name="mobile" placeholder="Mobile" required autofocus />
                            @error('mobile')
                            <h5 class="alert alert-danger">{{$message}}</h5>
                            @enderror
                        </div>
