...
<div class="container">
        ...
        <section id="basic-input">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Ean </h4>
            ...
            <div class="row">
                <div class="col-md-12">
                <form class="needs-validation" novalidate method="POST" action="{{route('master.ean.store')}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">

                            <label for="validationTooltip01">Ean Prefix</label>
                            <input type="text" class="form-control" name="prefix" placeholder="Prefix"  required autofocus  oninput="this.value = this.value.toUpperCase()"/>
                            @error('prefix')
