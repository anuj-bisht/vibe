            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Ean Master</h4>
                        <a class="btn btn-primary" href="{{route('master.ean.create')}}" type="submit"><svg
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm global_btn_color"
                                        href="{{route('master.ean.edit',['id'=>$ean->id])}}" type="submit"><svg
