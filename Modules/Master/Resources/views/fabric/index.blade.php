            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Fabric Master</h4>
                        <a class="btn global_btn_color" href="{{route('master.fabric.create')}}" type="submit"><svg
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm global_btn_color"
                                        href="{{route('master.fabric.edit',['id'=>$fabric->id])}}" type="submit"><svg
