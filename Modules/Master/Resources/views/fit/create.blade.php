...
<div class="container">
        ...
        <section id="basic-input">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Fit</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                <form class="" novalidate method="POST" action="{{route('master.fit.store')}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="fit_code" placeholder="Code"  required autofocus oninput="this.value = this.value.toUpperCase()"/>
                                    @error('fit_code')
                                ...
                                <div class="col-md-12 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Name"  required oninput="this.value = this.value.toUpperCase()"/>
                                    @error('name')
                                <h5 class="alert alert-danger">{{$message}}</h5>
                            @enderror
                                </div>
