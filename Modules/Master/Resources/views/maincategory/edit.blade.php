...
<div class="container">
        ...
        <section id="basic-input">
            ...
            <div class="row">
                <div class="col-md-12">
                <form class="" novalidate method="POST" action="{{route('master.maincategory.update',['id'=>$main_category->id])}}">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="category_name" value="{{$main_category->name}}" placeholder="Category Name"  required autofocus oninput="this.value = this.value.toUpperCase()"/>
