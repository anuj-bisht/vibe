...
<div class="container">
        ...
        <section id="basic-input">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Margin</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                <form class="" novalidate method="POST" action="{{route('master.margin.update',['id'=>$margin->id])}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="margin_code" placeholder="Code" value="{{$margin->code}}"  required autofocus/>
                                    @error('margin_code')
                                ...
                                <div class="col-md-12 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Name" value="{{$margin->name}}"  required />
                                    @error('name')
                                    <h5 class="alert alert-danger">{{$message}}</h5>
                                @enderror
                                </div>
