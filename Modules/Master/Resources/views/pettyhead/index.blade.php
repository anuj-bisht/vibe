            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Petty Head Master</h4>
                        <a class="btn btn-primary" href="{{route('master.pettyhead.create')}}" type="submit"><svg
                    ...
                    <table class="table" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$head->petty_heads}}</td>
                              
                                <td><a class="btn btn-sm global_btn_color"
                                        href="{{route('master.pettyhead.edit',['head'=>$head->id])}}" type="submit"><svg
