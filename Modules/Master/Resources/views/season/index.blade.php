            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Season Master</h4>
                        <a class="btn btn-primary" href="{{route('master.season.create')}}" type="submit"><svg
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm global_btn_color"
                                        href="{{route('master.season.edit',['id'=>$season->id])}}" type="submit"><svg
