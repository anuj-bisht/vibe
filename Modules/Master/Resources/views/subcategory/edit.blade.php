...
<div class="container">
        ...
        <section id="basic-input">
            ...
            <div class="row">
                <div class="col-md-12">
                <form class="" novalidate method="POST" action="{{route('master.subcategory.update',['id'=>$subcategory->id])}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="parent_id" name="parent_id" required autofocus>
                                 ...
                                 @if($categoryy->id == $subcategory->parent->id)
                        ...
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="subcategory_name" value="{{$subcategory->name}}" placeholder="Category Name"  required oninput="this.value = this.value.toUpperCase()"/>
