...
<div class="container">
        <section id="basic-input">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="needs-validation" novalidate method="POST" action="{{route('master.tax.store')}}">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Name"  required value="{{old('name')}}" autofocus oninput="this.value = this.value.toUpperCase()"/>
                            @error('name')
                        ...
                        <div class="col-md-12 col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="percent" value="{{old('percent')}}" placeholder="percent in %"  required />
                            @error('percent')
                                            <h5 class="alert alert-danger">{{$message}}</h5>
                                        @enderror
                        </div>
