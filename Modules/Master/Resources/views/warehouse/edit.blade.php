...
<div class="container">
    ...
    <form class="form" method="POST" action={{route('warehouse.update',['id'=>$warehouse->id])}} id="inputform">
        @csrf
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" style="color:black; font-weight:bold;">Edit Warehouse</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="last-name-column" class="form-control" placeholder="Warehouse Name" name="name" value="{{$warehouse->name}}" />
                                            </div>
                                            @error('name')
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column"  class="form-control" placeholder="Warehouse Address" name="address" value="{{$warehouse->address}}"/>
                                            @error('address')
                                            <h5 class="alert alert-danger">{{$message}}</h5>
                                        @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column"  class="form-control" placeholder="Warehouse Contact" name="contact" value="{{$warehouse->contact}}"/>
                                            @error('contact')
                                               <h5 class="alert alert-danger">{{$message}}</h5>
                                           @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="last-name-column"  class="form-control" placeholder="Warehouse Email" name="email" value="{{$warehouse->email}}"/>
                                            @error('email')
                                               <h5 class="alert alert-danger">{{$message}}</h5>
                                           @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="" name="type" data-index="14" onkeydown="setNextField(event)">
                                                ...
                                                <option value="Finished" @if($warehouse->type == 'Finished') selected @endif >Finished</option>
                                                <option value="Unfinished" @if($warehouse->type == 'Unfinished') selected @endif >Unfinished</option>
