...
<div class="container">
        ...
        <div class="card-datatable">
            <table class="table table-bordered" id="deposit" width="100%" cellspacing="0" style="">
                <thead class="">
...
<script>
      $(function() {
            $('#deposit').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{!! route('retaildeposit.listing')!!}",
                columns: [
                    {
                        data: 'retail_name'
                    },
