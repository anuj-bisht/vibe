        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table table-bordered" id="customerInvoiceListing" width="100%" cellspacing="0" >
                        <thead class="">
...
function load_data(from_date = '', to_date = ''){
           $('#customerInvoiceListing').DataTable({ 
                processing: true,
                serverSide: true,
                searchable : true,

              
                ajax: "{!! route('retailcustomer.invoiceListing') !!}",
                columns: [
                    // {
                    //     data: 'DT_RowIndex'
                    // }, 
        ...
        $('#filter').click(function(){
          ...
          if(from_date != '' &&  to_date != ''){
              $('#customerInvoiceListing').DataTable().destroy();
